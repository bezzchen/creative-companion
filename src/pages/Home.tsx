          ...
          <div className="relative z-10">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-30">
              ...
              <motion.button
                ...
                className={`w-30 h-30 rounded-full flex items-center justify-center shadow-xl ${
              ...
              <motion.button
                ...
                className="absolute w-30 h-30 rounded-full bg-destructive flex items-center justify-center shadow-lg"
